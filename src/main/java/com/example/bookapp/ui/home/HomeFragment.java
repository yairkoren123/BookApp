...
public class HomeFragment extends Fragment {
    ...
    ArrayList<String> final_title_list = new ArrayList<>();
...
//                {"Fantasy","History","Horror","Music","Mystery","Sports","Travel"};
        ...
        String[] cat = new String[]
                {"History", "Horror", "Music", "Sports", "Travel"};
    ...
    //            }
                    ...
                    getActivity().runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            Single_one single_one = Single_one.getInstance();
                            if (single_one.getTitle1().size() > 1) {

                                final_title_list = single_one.getFinal_titles();
                                ...
                                for (int i = 0; i < 5; i++) {
                                    ...
                                    final_title_list.add(Subject_Headings.get(index));
...
//                for (int i = 0; i < body.select("div").size(); i++) {
                ...
                by_value(random,COMPUTERS_array);
...
//                    });
        ...
        public  void go_again(){
            ...
            Log.d("resu", "onResume: 2" );


            for (int i = 0; i < 6; i++) {

                Log.d("nowi", "onResume: " + i );
                single_one = Single_one.getInstance();
                ...
                switch (i){
                    case 1 :
                        ...
                        the_random = final_title_list.get(i-1);

                        ArrayList<The_Book> try1 = single_one.getTitle1();
                        ...
                        Log.d("1switch1", "call_rec: now in switch 1 ");

                        TextView textView1 = binding.textView1;


                        textView1.setText(the_random);
                    ...
                    case 2 :
                        ...
                        ArrayList<The_Book> try2 = single_one.getTitle2();
                        ...
                        Log.d("1switch1", "call_rec: now in switch 2 ");

                        TextView textView2 = binding.textView2;


                        textView2.setText(the_random);
                    ...
                    case 3 :
                        ...
                        ArrayList<The_Book> try3 = single_one.getTitle3();
                        ...
                        Log.d("1switch1", "call_rec: now in switch 3 ");

                        TextView textView3 = binding.textView3;


                        textView3.setText(the_random);
                    ...
                    case 4 :
                        ...
                        ArrayList<The_Book> try4 = single_one.getTitle4();
                        ...
                        Log.d("1switch1", "call_rec: now in switch 4 ");

                        TextView textView4 = binding.textView4;


                        textView4.setText(the_random);
                    ...
                    case 5 :
                        ...
                        ArrayList<The_Book> try5 = single_one.getTitle5();
                        ...
                        Log.d("1switch1", "call_rec: now in switch 5 ");

                        TextView textView5 = binding.textView5;


                        textView5.setText(the_random);
        ...
        public void by_value(String random, ArrayList<The_Book> take_this) {
            ...
            COMPUTERS_array = take_this;

            Log.d("towaitch", "by_value: " + rec_now);
            switch (rec_now) {
                case 1:
    ...
    public void onPause() {
        ...
        single_one.setFinal_titles(final_title_list);
        super.onPause();
    }
